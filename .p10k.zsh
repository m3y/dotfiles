# Generated by Powerlevel10k configuration wizard on 2019-12-14 at 01:24 JST.
...
# right frame, darkest, compact, many icons, fluent, transient_prompt,
# instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND='yellow'
